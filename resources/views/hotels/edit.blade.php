...
<style>
    ...
    .form-card-header {
        background: var(--parchment2); border-bottom: 1.5px solid var(--line);
        padding: 1rem 1.5rem;
    ...
    .form-card-header-text .title { font-size: 0.88rem; font-weight: 600; color: var(--ink); }
    .form-card-header-text .subtitle { font-size: 0.72rem; color: var(--ink-soft); }
    ...
    .hotel-strip-id {
        font-size: 0.7rem; color: var(--ink-soft); margin-top: 0.1rem;
    }
    ...
    .field-textarea { resize: vertical; min-height: 90px; padding-top: 0.68rem; }

    .field-input:focus, .field-textarea:focus {
        border-color: var(--amber);
        box-shadow: 0 0 0 3px rgba(199,125,47,0.12);
        background: #fff;
    }

    .field-input-wrap:focus-within .field-icon { color: var(--amber); }
    ...
    .btn-update {
        ...
        box-shadow: 0 2px 8px rgba(199,125,47,0.22);
    }
    .btn-update:hover {
        background: #b06a22; transform: translateY(-1px);
        box-shadow: 0 4px 14px rgba(199,125,47,0.32);
    }
    ...
    @media (max-width: 560px) {
        .form-page-title { flex-direction: column; align-items: flex-start; }
    }
</style>
    ...
    <div class="form-card">
        ...
        <div class="form-card-header">
            <div class="form-card-icon">
                <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
                    ...
                    <path d="M6 3l2 2" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/>
                </svg>
            </div>
            <div class="form-card-header-text">
                <div class="title">Ubah Informasi Hotel</div>
                <div class="subtitle">Perubahan akan langsung tersimpan setelah dikonfirmasi</div>
            </div>
        </div>
        ...
        <div style="padding: 1.25rem 1.5rem 0;">
            <div class="hotel-strip">
                <div class="hotel-strip-icon">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                        <path d="M2 15V7L8 3l6 4v8" stroke="currentColor" stroke-width="1.4" stroke-linejoin="round"/>
                        <rect x="5.5" y="9.5" width="5" height="5.5" rx="0.5" stroke="currentColor" stroke-width="1.3"/>
                    </svg>
                </div>
                <div>
                    <div class="hotel-strip-name">{{ $hotel->nama_hotel }}</div>
                    <div class="hotel-strip-id">ID #{{ $hotel->id }}</div>
                </div>
            </div>
        </div>
                ...
                <div class="field-group" style="margin-bottom:0;">
                    ...
                    <div class="field-input-wrap">
                        ...
                        <input type="text" id="no_telp" name="no_telp"
                               ...
                               value="{{ old('no_telp', $hotel->no_telp) }}"
                               required>
                    </div>
                    <p class="field-hint">
                        <svg width="11" height="11" viewBox="0 0 11 11" fill="none">
